...
Page({
  ...
  onShow() {
    ...
    this.reloadSlots(false, this.data.storeId, this.data.storeName);
  },

  /** 未初始化或演示未匹配到清单时，跳转广告位初始化页 */
  goInitSlots() {
    const storeId = this.data.storeId;
    if (!storeId) return;
    wx.navigateTo({
      url:
        '/packageBiz/pages/inspector-store-init/inspector-store-init?storeId=' +
